...
const configs = {
  entities: {
    uri:
      process.env.mongodbConStrEntity ||
      "mongodb://localhost:27017/entity_service",
  ...
  events: {
    uri:
      process.env.mongodbConStrEvent ||
  ...
  projects: {
    uri:
      process.env.mongodbConStrProject ||
      "mongodb://localhost:27017/project_service",
  ...
  users: {
    uri:
      process.env.mongodbConStrUser || "mongodb://localhost:27017/user_service",
  ...
  votes: {
    uri:
      process.env.mongodbConStrVote || "mongodb://localhost:27017/vote_service",
  ...
  schedule: {
    uri:
      process.env.mongodbConStrVote ||
      "mongodb://localhost:27017/schedule_service",
